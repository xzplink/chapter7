...
sender = 'zhaozhang@163.com'#发件人地址
receiver = 'zhaozhang@163.com'#收件人地址
...
def send_email(msg,file_name):
    ...
    att["Content-Disposition"] = 'attachment; filename="%s"'% os.path.basename(file_name.encode('utf-8'))
...
if __name__ == "__main__":
    MSG="测试程序test"#要发送的文字
    # print MSG
    FILE="D:/测试suricata-0.8.0.tar.gz"#要发送的文件
    send_email(MSG,FILE)
    # try:
    #     send_email(MSG,FILE)
    # except Exception,e:
